...
Проект распространяется с открытым исходным кодом. Все права защищены автором.
Форки и модификации разрешены строго при условии сохранения полного авторства, уведомлений об авторских правах и ссылки на оригинальный репозиторий.
