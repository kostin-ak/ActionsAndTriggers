package kostin.ak.actionstriggers.api.hook;
 ...
 * Находится в модуле API, работает через reflection и не требует зависимостей на этапе компиляции.
 */
public class PapiHook {
    ...
    private static void checkInit() {
        ...
        initialized = true;
        try {
            if (Bukkit.getPluginManager() != null && Bukkit.getPluginManager().getPlugin("PlaceholderAPI") != null) {
