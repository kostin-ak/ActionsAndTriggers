 ...
 * Размещено в API для использования сторонними плагинами.
 */
public class GuiDefinition {
    ...
    private boolean closeOnDamage = true;
    ...
    public void setCloseOnDamage(boolean closeOnDamage) { this.closeOnDamage = closeOnDamage; }
