...
public class SlotCoverWidget extends AbstractWidget {
    ...
    private static java.util.function.Function<String, String> configProvider = key -> null;

    public static void setConfigProvider(java.util.function.Function<String, String> provider) {
    ...
    public void render(@NotNull GuiContext ctx, @NotNull Map<Integer, ItemStack> matrix) {
        ...
        if (item == null) {
            String globalPrimary = configProvider.apply("gui.slot_cover.primary");
        ...
        if (item == null) {
            String globalFallback = configProvider.apply("gui.slot_cover.fallback");
