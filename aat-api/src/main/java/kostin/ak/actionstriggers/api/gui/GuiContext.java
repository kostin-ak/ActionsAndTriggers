...
public class GuiContext {
    ...
    private static java.util.function.Consumer<GuiContext> refreshHandler;

    public static void setRefreshHandler(java.util.function.Consumer<GuiContext> handler) {
